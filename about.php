		...
		<div class="container">
			<div class="row center-xs center-sm center-md center-lg">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<p>FIVE Studios specializes in the production of fresh, innovative apps for mobile users. We are currently working on our flagship, 'The FIVE App', an interactive, community-based bar-hopping app that ensures nobody stays thirsty on any given night! It's always 5 o'clock somewhere.</p>
					<p></p>
					...
					<div class="boxl col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<img src="./images/corey.jpg" style="width:100%">
						<h3>Corey Ervin</h3>
						<p>Director of Software Engineering</p>
					</div>

					<div class="boxr col-xs-12 col-sm-6 col-md-6 col-lg-6"">
